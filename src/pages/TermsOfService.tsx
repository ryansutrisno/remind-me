...
export function TermsOfService() {
  ...
  if (lang === 'id') {
    return (
      <LegalLayout title={t('nav.terms')}>
        ...
        <p className="mb-4">
          Dengan mengakses dan menggunakan aplikasi <strong>Remind Me</strong>, Anda menyetujui untuk terikat oleh Syarat & Ketentuan Layanan ini. Jika Anda tidak setuju dengan ketentuan ini, Anda dilarang menggunakan aplikasi ini.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-2">2. Deskripsi Layanan</h3>
        <p className="mb-4">
          Remind Me adalah aplikasi antarmuka klien (client-side) yang mempermudah Anda mengelola pengingat kalender menggunakan akun Google Calendar Anda. Layanan ini disediakan secara "sebagaimana adanya" dan "sebagaimana tersedia".
        </p>
        ...
        <p className="mb-4">
          Remind Me dan <strong>trazmedia.com</strong> tidak bertanggung jawab atas kerugian langsung, tidak langsung, insidental, atau konsekuensial yang diakibatkan oleh:
        </p>
  ...
  return (
    <LegalLayout title={t('nav.terms')}>
      ...
      <p className="mb-4">
        By accessing and using the <strong>Remind Me</strong> application, you agree to be bound by these Terms of Service. If you do not agree with these terms, you are prohibited from using this application.
      </p>

      <h3 className="text-xl font-semibold mt-6 mb-2">2. Description of Service</h3>
      <p className="mb-4">
        Remind Me is a client-side interface application that makes it easier for you to manage calendar reminders using your Google Calendar account. This service is provided on an "as is" and "as available" basis.
      </p>
      ...
      <p className="mb-4">
        Remind Me and <strong>trazmedia.com</strong> shall not be liable for any direct, indirect, incidental, or consequential damages resulting from:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
