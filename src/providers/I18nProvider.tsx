...
const dict: Dict = {
  ...
  'filter.range': { en: 'Range', id: 'Rentang' },
  'range.thisYear': { en: 'This year', id: 'Tahun ini' },
  'range.thisMonth': { en: 'This month', id: 'Bulan ini' },
  'range.thisWeek': { en: 'This week', id: 'Minggu ini' },
  'range.lastYear': { en: 'Last year', id: 'Tahun terakhir' },
  'range.lastMonth': { en: 'Last month', id: 'Bulan terakhir' },
  'range.lastWeek': { en: 'Last week', id: 'Minggu terakhir' },
